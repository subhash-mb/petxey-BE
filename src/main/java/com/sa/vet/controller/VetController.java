...
public class VetController {
	...
	public ResponseEntity<?> post(@RequestBody VetDto vet) throws ResourceAlreadyExistException {
	...
	@DeleteMapping("/vet/deleteVetById/{npiNo}")
	...
	public ResponseEntity<?> editVets(@RequestBody VetDto vet) {
		ResponseEntity<?> response = null;
		try {
